...
def plot_attack_time_acc(title, acc_average, acc_node_list, save_path=None, is_acc=True, plot_size="L"):
    font_settings = get_font_settings(plot_size)
    ...
    axes.set_xlabel("Round Number", **font_settings.get("cs_xy_label_font"))
    if is_acc:
