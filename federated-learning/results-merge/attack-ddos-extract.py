...
def main():
    ...
    final_time = 300
    exp_node_number = "ddos-attack"
    model_name = "cnn"
    dataset_name = "cifar"
    # experiments = ["fed_async_classic_ddos_00", "fed_async_classic_ddos_80", "fed_async_classic_ddos_90"]
    experiments = ["fed_async_ddos_00", "fed_async_ddos_80", "fed_async_ddos_90"]
